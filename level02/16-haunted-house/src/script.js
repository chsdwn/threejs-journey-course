...
const walls = new THREE.Mesh(
  new THREE.BoxBufferGeometry(4, wallHeight, wallWidth),
...
roof.rotation.y = Math.PI / 4 // PI = 180°
house.add(roof)

// Door
const door = new THREE.Mesh(
  // (2, 2) to work Alpha map. (100, 100) height/displacement map need a lot vertices to work
  new THREE.PlaneBufferGeometry(2.2, 2.2, 100, 100),
  new THREE.MeshStandardMaterial({
    transparent: true, // Need to work alpha/opacity
    alphaMap: doorAlphaTexture,
    aoMap: doorAmbientOcclusionTexture, // Not works w/o uv coordinates
...
door.geometry.setAttribute('uv2',
  new THREE.Float32BufferAttribute(door.geometry.attributes.uv.array, 2)) // itemSize = 2 bc the material is 2d
door.position.y = 2 / 2
door.position.z = wallWidth / 2 + 0.01 // Prevent z fighting
house.add(door)
