...
directionalLight.shadow.normalBias = 0.05 // Shrinks the burger so it can't creates shadows itself
...
const renderer = new THREE.WebGLRenderer({
  canvas,
  antialias: true // Needs to be defined when initializing object
})
renderer.setSize(sizes.width, sizes.height)
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2))
renderer.physicallyCorrectLights = true
// renderer.outputEncoding = THREE.GammaEncoding
renderer.outputEncoding = THREE.sRGBEncoding // GammeEncoding with default gamma factor of 2.2
